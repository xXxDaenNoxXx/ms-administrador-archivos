 ...
 *
 * NOTA: no se reenvia el Authorization aqui. msrabbitmq dejo /api/guias/**
 * con permitAll() en su SecurityConfig, ya que este trafico es interno
 * (solo lo llama este microservicio, nunca se expone al exterior). Ver
 * SecurityConfig.java de msrabbitmq para el detalle de esa decision.
 */
@Slf4j
@Service
